    ...
    <div className="container relative mx-auto px-4 lg:px-8 text-center z-10">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-amber-500/10 backdrop-blur-md border border-amber-400/30 mb-10 shadow-[0_0_30px_rgba(251,191,36,0.15)]"
        >
        ...
        {/* Main Heading */}
        <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-heading leading-[1.15] mb-8">
          <motion.span
        ...
        <motion.p
          ...
          className="text-base sm:text-lg lg:text-xl text-white/80 font-body max-w-2xl mx-auto mb-12 leading-relaxed"
        >
        ...
        >
          <Link
            to="/products"
            className="inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-amber-500 via-amber-600 to-amber-500 text-white px-10 py-4 rounded-xl font-heading font-bold text-sm tracking-wide hover:shadow-[0_0_30px_rgba(251,191,36,0.5)] hover:scale-105 transition-all duration-300 group"
          >
            <span>Shop Now</span>
          ...
          <Link
            to="/gallery"
            className="inline-flex items-center justify-center gap-2.5 border-2 border-white/30 text-white px-10 py-4 rounded-xl font-heading font-bold text-sm tracking-wide hover:bg-white/10 hover:border-white/50 transition-all duration-300 backdrop-blur-sm"
          >
            View Gallery
          </Link>
        </motion.div>
